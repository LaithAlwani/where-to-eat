...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-linear-to-b from-brand-100 via-brand-50 to-surface">
        <div className="mx-auto flex w-full max-w-3xl flex-col items-center gap-5 px-4 py-12 text-center sm:py-16">
